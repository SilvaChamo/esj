...
-- Biblioteca científica (acervo / produção científica)
-- Pode correr isolado no SQL Editor do Supabase.
...
-- Docência (materiais de ensino partilhados pelos docentes por cadeira)
-- Pode correr isolado no SQL Editor do Supabase.
