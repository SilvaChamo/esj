  ...
  return (
    <div onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}>
      <div className="overflow-hidden">
        <div
          className={`flex ${semTransicao ? "" : "transition-transform duration-500 ease-in-out"}`}
        ...
        >
          {estendido.map((item, i) => (
            ...
            >
              <div className="h-[200px] border border-navy-100 p-4 bg-white group-hover/card:border-sky group-hover/card:bg-cream transition-colors overflow-hidden">
