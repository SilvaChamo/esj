        ...
        {n > visiveis && (
          <>
            <button
              ...
              className="absolute left-[-16px] top-1/2 -translate-y-1/2 flex items-center justify-center w-8 h-8 rounded-full border border-navy-100 bg-white text-navy-900 shadow hover:border-sky hover:text-sky transition-colors"
            >
              <ChevronLeft size={16} />
            </button>
            <button
              ...
              aria-label="Seguinte"
              onClick={() => setIndex((i) => i + 1)}
              className="absolute right-[-16px] top-1/2 -translate-y-1/2 flex items-center justify-center w-8 h-8 rounded-full border border-navy-100 bg-white text-navy-900 shadow hover:border-sky hover:text-sky transition-colors"
            >
