    ...
    <>
      ...
      {destaque.length > 0 ? (
        <>
          ...
          <EntradaHome atraso={0.1}>
            <div className="mt-10 flex justify-center">
              <Link
                href="/galeria"
                className="esj-btn-move inline-flex items-center border border-sky bg-transparent text-sm font-semibold text-sky px-5 py-2.5 hover:text-crimson hover:border-crimson"
              >
                Ver mais álbuns →
              </Link>
            </div>
